...
export class LinesBulkComponent implements OnInit {
  excelLoaded: boolean = false;
  excelFile: any;
  baseUrl: string = "";
  fileUrl: string = "";
  constructor(private _router: Router, private _uploadService: LineService, private _configService: ConfigService) { 
    this.baseUrl = this._configService.getBackURI();
    this.fileUrl = this.baseUrl + "assets/files/cargue_masivo_lineas.xlsx";
  }
