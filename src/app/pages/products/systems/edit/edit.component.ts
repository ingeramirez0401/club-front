...
export class SystemsEditComponent implements OnInit {
  ...
  specialityList: any [] = [];
  lineList: any [] = [];
  constructor(private _sidebarService: SidebarService, private _router: Router, private _localStorage: LocalStorageService, private _appService: AppService, private _systemService: SystemService, private _activatedRoute: ActivatedRoute, private _specialityService: SpecialityService) {
    ...
    this._activatedRoute.params.subscribe((params)=>{
      ...
      this._systemService.getSystem(this.systemId).subscribe((result)=>{
        ...
        this.forma.setValue(systemEdit);
        setTimeout(() => {
          this.setSpeciality();
        }, 1000);
      },
  ...
  saveChanges() {
    ...
    this._systemService.updateSystem(this.forma.value)
    .subscribe(result => {
      $('body').loading('stop');
