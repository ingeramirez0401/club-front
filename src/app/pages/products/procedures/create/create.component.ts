...
export class ProceduresCreateComponent implements OnInit {
  forma:FormGroup;
  userProfile: UserProfileModel;
  specialityList: any [] = [];
  lineList: any [] = [];
  constructor(private _sidebarService: SidebarService, private _router: Router, private _localStorage: LocalStorageService, private _appService: AppService, private _procedureService: ProcedureService, private _specialityService: SpecialityService) {
  ...
  saveChanges() {
    ...
    this._procedureService.saveProcedure(this.forma.value)
    .subscribe(result => {
      $('body').loading('stop');
